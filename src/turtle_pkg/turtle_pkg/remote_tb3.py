    ...
    try:
        ...
        while rclpy.ok():
            ...
            if key == 'w':
                ...
                if tw.angular.x + ANG_STEP <= MAX_ANG_SPD: 
                    tw.angular.x = tw.angular.x + ANG_STEP
                else: 
                    tw.angular.x =MAX_ANG_SPD       
            elif key == 'd':
                if tw.angular.x - ANG_STEP >= MIN_ANG_SPD: 
                    tw.angular.x = tw.angular.x - ANG_STEP
                else: 
                    tw.angular.x =MIN_ANG_SPD   
            elif key == ' ':
                print("stop")
